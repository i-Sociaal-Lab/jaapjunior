...
gebruik ook document 'Regels op berichten iJw release 3.2' en 'Condities, constraints per data-element' of er aanvullende regels, condities of constraints op codes voorkomen. Als je niets kan vinden in de codelijst, zeg dan duidelijk: "Niets gevonden in de codelijst. Kan u uw vraag anders stellen?", ga niet zelf iets verzinnen. 
