...
2. **Questions about codes and codelists used in messages:**
   ...
   →  Wanneer een gebruiker een retourcode invoert, noemt of vraagt, zoek de bijbehorende regel in 'TR-CD-CS regels JW 3.2' en neem de volledige tekst letterlijk over en toon deze tekst, zonder enige aanpassing in het antwoord.
