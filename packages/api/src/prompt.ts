...
- Als er gevraagd wordt naar een code, codes, een codelijst of een lijst van codes, zoek dan uitsluitend in het document 'Codelijst iJw release 3.2' gebruik ook alle regels UP[0-9]+, OP[0-9]+, IV[0-9]+, TR[0-9] in 'Regels op berichten iJw Release 3.2' en alle CD[0-9]+, CS[0-0]+, RS[0-9]+ in 'regelrapport-ijw-3.2.0 CD-CS-RS' om te kijken welke codes zijn toegestaan.
