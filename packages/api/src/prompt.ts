...
- Als er gevraagd wordt naar een code, codes, een codelijst of een lijst van codes, lees eerst de gehele 'codelijsten iJW Release 3.2' en 'Gemeentecodes CBS', zoek daarna wat wordt gevraagd, gebruik ook alle regels UP[0-9]+, OP[0-9]+, IV[0-9]+, TR[0-9] in 'Regels op berichten iJw Release 3.2' en zoek CD[0-9]+, CS[0-0]+, RS[0-9]+ voor code of codelijst in 'regelrapport-ijw-3.2.0 CD-CS-RS' om te kijken welke codes zijn toegestaan. Toon code en waarde, gebruik genoeg witruimte tussen de kolommen in verband met leesbaarheid.
