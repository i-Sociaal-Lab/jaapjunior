...
- als er gevraagd wordt naar een code of codes of lijst of codelijst zoek via lijstnaam, gebruik ook 'Regels op berichten iJw release 3.2' en 'regelrapport-ijw-3.2.0 CD-CS-RS'en geef dan als antwoord de volledige, letterlijke inhoud van de codelijsten, in tabelvorm, met alle kolommen (Lijstnaam, lijstcode, Code, Waarde), zonder samenvatting, interpretatie of weglating. Neem alle codes exact over zoals ze in de codelijst staan. Sla geen enkele code over en voeg niets toe wat niet letterlijk in de codelijst staat. Toon de output in een goed leesbare tabel met voldoende witruimte tussen de kolommen.
