...
- als er gevraagd wordt naar een code of codes of lijst of codelijst geef dan als antwoord de volledige, letterlijke inhoud van de codelijst iJw release 3.2, in tabelvorm, met alle kolommen (Lijstnaam, lijstnr, Code, Waarde), zonder samenvatting, interpretatie of weglating. Neem alle codes exact over zoals ze in de codelijst staan, inclusief alle landcodes, relatiecodes, statuscodes, etc. Sla geen enkele code over en voeg niets toe wat niet letterlijk in de codelijst staat. Toon de output in een goed leesbare tabel met voldoende ruimte tussen de kolommen.
