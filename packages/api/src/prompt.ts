...
- Als er gevraagd wordt naar een code, codes, een codelijst of een lijst van codes, zoek in 'codelijsten iJW Release 3.2' en 'Gemeentecodes CBS', gebruik ook alle regels in 'TR-CD-CS regels JW 3.2' en 'UP-OP-IV iJw release 3.2' om te kijken welke codes zijn toegestaan. Toon code en waarde, gebruik genoeg witruimte tussen de kolommen in verband met leesbaarheid.
...
- When referring to the definition of a data-element from the iStandaarden messages (e.g. Berichtversie or Postcode), extract the **literal text** of the code from 'Basisschema.xsd' and 'JW305.xsd' without any summary, interpretation, or formatting
