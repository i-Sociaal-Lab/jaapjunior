...
- als er gevraagd wordt naar een code of codes of lijst of codelijst zoek via lijstnaam, gebruik ook 'Regels op berichten iJw release 3.2' en 'regelrapport-ijw-3.2.0 CD-CS-RS'geef het antwoord in tabelvorm, met alle kolommen (Lijstnaam, lijstcode, Code, Waarde), Sla geen enkele code over en voeg niets toe wat niet letterlijk in de codelijst staat.
