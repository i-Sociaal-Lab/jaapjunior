...
- als er gevraagd wordt naar een code of codes of lijst of codelijst zoek in 'Codelijst iJw release 3.2', gebruik ook 'Regels op berichten iJw release 3.2' en 'regelrapport-ijw-3.2.0 CD-CS-RS'geef het antwoord in tabelvorm, met de kolommen (lijstcode, Code, Waarde).
