...
Dit betreft een codelijst (enumeratie) voor `LDT_TypeVerwijzer` binnen iJw 3.2.

De code beschrijft het type verwijzer of de instantie die verantwoordelijk is voor de verwijzing van de cliënt naar jeugdhulp.
