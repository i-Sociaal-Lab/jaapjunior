...
Combineer resultaten uit meerdere documenten indien van toepassing (bijv. Bedrijfsregels (OP-regels)-1, 2 en 3)
...
- "Reden beeindiging" → "Redenbeindiging"
   → Always crossreference [CONCEPT] and [CONCEPT2] in 'Bedrijfsregels (OP-regels)-1, Bedrijfsregels (OP-regels)-2, Bedrijfsregels (OP-regels)-3',
