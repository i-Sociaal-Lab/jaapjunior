...
- **Document:** Overeenkomst Maatwerkvoorzieningen maatschappelijke ondersteuning
- **Versie:** 1.3
- **Datum versie:** oktober 2026
- **Bronorganisatie:** Ketenbureau
- **Toepassing:** maatwerkvoorzieningen maatschappelijke ondersteuning (Wmo)
- **Status:** brongetrouwe, chatbotvriendelijk gestructureerde versie

## Gebruik voor chatbot/RAG

- Gebruik de tekst onder **Brontekst** als primaire bron voor inhoudelijke antwoorden.
- Behoud de termen **Opdrachtgever**, **Opdrachtnemer**, **Partijen** en **maatschappelijke ondersteuning**.
- Maak onderscheid tussen bepalingen die **verplicht** zijn en bepalingen die met **[Optioneel:]** zijn gemarkeerd.
- Beantwoord vragen over een specifiek artikel primair vanuit dat artikel en de bijbehorende leden.
- Voeg geen juridische interpretatie toe die niet uit de overeenkomst blijkt.
- Als de vraag niet uit deze overeenkomst kan worden beantwoord, geef aan dat de informatie niet in de overeenkomst versie 1.3 staat.
- Let op: tekst tussen blokhaken, zoals `[Vul in]`, `[begindatum]` en `[Naam Gemeente]`, zijn invulvelden in het model.

## Zoektermen

`Wmo` `Contractstandaarden` `Overeenkomst` `versie-1.3` `maatwerkvoorzieningen` `Opdrachtgever` `Opdrachtnemer` `VOG` `UBO` `fraude` `integriteit` `toezicht` `onderaanneming` `indexering` `iWmo` `declaratie` `opzegging` `ontbinding` `aansprakelijkheid` `contractwijziging` `persoonsgegevens`

---

# Bronbestand

**Overeenkomst Maatwerkvoorzieningen maatschappelijke ondersteuning – versie 1.3, oktober 2026.**
...
- Wat staat er in artikel 1.2 over hiërarchische volgorde documenten	11?
...
- Wat staat er in artikel 3.1 over levering van maatschappelijke ondersteuning	19?
...
- Wat staat er in artikel 3.4 over continuïteit van maatschappelijke ondersteuning	20?
...
- Wat staat er in artikel 3.5 over wachttijden en cliëntenstop door opdrachtgever	21?
...
- Wat staat er in artikel 3.7 over weigering en beëindiging van maatschappelijke ondersteuning	22?
...
- Wat staat er in artikel 3.8 over wijziging ondersteuningsbehoefte	22?
...
- Wat staat er in artikel 3.9a over verklaring omtrent gedrag personeel	23?
...
- Wat staat er in artikel 3.10 over informatievoorziening aan de gemeente	24?
...
- Wat staat er in artikel 3.13 over declaratie en betaling van de geleverde maatschappelijke ondersteuning	27?
...
- Wat staat er in artikel 3.15 over ubo (ultimate beneficial owner)	28?
...
- Wat staat er in artikel 3.19 over niet-nakoming, opzegging en ontbinding	30?
...
- Wat staat er in artikel 3.20 over overdracht van rechten en fusie	32?
...
- Wat staat er in artikel 3.21 over financiële verantwoordelijkheid	32?
...
- Wat staat er in artikel 3.26 over kennisgevingen en algemene inkoopvoorwaarden	33?
...
- Wat staat er in artikel 3.30 over wijziging van de contractstandaard	34?
...
(Bij aanbestedingsprocedure met EMVI-criterium:) Opdrachtnemer de economisch meest voordelige inschrijving indiende en  Opdrachtgever daarom de opdracht aan hem wil geven;
...
Specifieke toewijzing: Opdrachtgever bepaalt in een opdracht aan Opdrachtnemer productcategorie, code en omvang van de ondersteuning voor een cliënt.
...
d) Opdrachtgever informeert minimaal 3 kalendermaanden vooraf over het besluit over duur en hoogte van bestedingsruimte.
...
de aard van de ondersteuningsbehoefte en het aantal cliënten dat het betreft;
...
gemaakte prestatieafspraken en samenwerking met het lokaal team (als aanwezig).
...
Opdrachtgever informeert andere betrokkenen direct volgens de afspraken in het plan.
...
- Wat staat er in artikel 3.1 over levering van maatschappelijke ondersteuning?
- Wat bepaalt artikel 3.1?
...
- Wat staat er in artikel 3.5 over wachttijden en cliëntenstop door opdrachtgever?
- Wat bepaalt artikel 3.5?
...
- Wat staat er in artikel 3.7 over weigering en beëindiging van maatschappelijke ondersteuning?
- Wat bepaalt artikel 3.7?
...
- Wat staat er in artikel 3.9a over verklaring omtrent gedrag personeel?
- Wat bepaalt artikel 3.9a?
...
- Wat staat er in artikel 3.10 over informatievoorziening aan de gemeente?
- Wat bepaalt artikel 3.10?
...
- Wat staat er in artikel 3.13 over declaratie en betaling van de geleverde maatschappelijke ondersteuning?
- Wat bepaalt artikel 3.13?
...
- Wat staat er in artikel 3.26 over kennisgevingen en algemene inkoopvoorwaarden?
- Wat bepaalt artikel 3.26?
...
3. Geef daarna alleen de relevante bepalingen uit de brontekst weer of vat die brongetrouw samen.
